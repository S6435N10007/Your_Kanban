                ...
                <main>
                    <div class="container-fluid px-4">
                        <div class="card mb-4">
                            ...
                            <div>
                                <br>
                                <a href="order_report_new.php"><button type="button" class="btn btn-outline-warning active">New</button></a>
                            ...
                            <br>
                            <div>
                                <form name="form1" method="POST" action="order_report_new.php">
                                    <div class="row">
                                        <div class="col-sm-2">
                                    ...
                                    <tbody>
                                        ...
                                        if($date1 != "" && $date2 != ""){
                                            ...
                                            $sql = "SELECT * 
                                                    ...
                                                    WHERE o_status = '0' AND o_time BETWEEN '$date1' AND '$date2'
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <b style='color:yellow'><?php echo $row['order_status']; ?></b>
                                            </td>
                                            <td>
                                            <a href="order_detail_report.php?id=<?php echo $row['o_id']; ?>" class="btn btn-light">Detail</a>
                                            </td>
                                            <td>
                                            <a href="pay_order.php?id=<?php echo $row['o_id']; ?>" class="btn btn-primary" onclick = "payOrder(this.href); return false;">Shipping</a>
                                            </td>
                                            <td>
