                    ...
                    <div class="container-fluid px-4">
                        <div class="card mb-4">
                            ...
                            <div>
                                ...
                                <a href="order_report_shipping.php"><button type="button" class="btn btn-outline-primary active">Shipping</button></a>
                                <a href="order_report_canceled.php"><button type="button" class="btn btn-outline-danger">Canceled</button></a>
                                <a href="order_report_completed.php"><button type="button" class="btn btn-outline-success">Completed</button></a>
                            </div>
                            <br>
                            <div>
                                <form name="form1" method="POST" action="order_report_paid.php">
                                    <div class="row">
                                        <div class="col-sm-2">
                                    ...
                                    <tbody>
                                        ...
                                        if($date1 != "" && $date2 != ""){
                                            ...
                                            $sql = "SELECT * 
                                                    ...
                                                    WHERE o_status = '1' AND o_time BETWEEN '$date1' AND '$date2'
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <b style='color:blue'><?php echo $row['order_status']; ?></b>
                                            </td>
                                            <td>
                                            <a href="order_detail_report.php?id=<?php echo $row['o_id']; ?>" class="btn btn-light">Detail</a>
                                            </td>
                                            <td>
                                            <a href="complete_order.php?id=<?php echo $row['o_id']; ?>" class="btn btn-success" onclick = "completeOrder(this.href); return false;">Completed</a>
                                            </td>
                                            <td>
                                            <a href="cancel_order.php?id=<?php echo $row['o_id']; ?>" class="btn btn-danger" onclick = "cancelOrder(this.href); return false;">Cancel</a>
                                            </td>
                                        </tr>
                                        <?php
                                        }
