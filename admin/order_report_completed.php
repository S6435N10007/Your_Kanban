                    ...
                    <div class="container-fluid px-4">
                        <div class="card mb-4">
                            ...
                            <div>
                                ...
                                <a href="order_report_completed.php"><button type="button" class="btn btn-outline-success active">Completed</button></a>
                            </div>
                            <br>
                            <div>
                                <form name="form1" method="POST" action="order_report_completed.php">
                                    <div class="row">
                                        <div class="col-sm-2">
                                    ...
                                    <tbody>
                                        ...
                                        if($date1 != "" && $date2 != ""){
                                            ...
                                            $sql = "SELECT * 
                                                    ...
                                                    WHERE o_status = '2' AND o_time BETWEEN '$date1' AND '$date2'
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <b style='color:green'><?php echo $row['order_status']; ?></b>
                                            </td>
                                            <td>
